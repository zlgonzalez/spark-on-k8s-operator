...
import (
	...
	sparkoperatork8siov1alpha1 "github.com/zlgonzalez/spark-on-k8s-operator/pkg/apis/sparkoperator.k8s.io/v1alpha1"
	versioned "github.com/zlgonzalez/spark-on-k8s-operator/pkg/client/clientset/versioned"
	internalinterfaces "github.com/zlgonzalez/spark-on-k8s-operator/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/zlgonzalez/spark-on-k8s-operator/pkg/client/listers/sparkoperator.k8s.io/v1alpha1"
